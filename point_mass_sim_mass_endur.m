...
[em268, me268] = meshgrid(energy, mass);
...
function [sim_score, a_power, p_power, total_power] = compete(car, comp, events)
    ...
    disp(endur_time/22);
    total_power = a_power*(endur_time/3600);
    sim_score = lap2score(accel_time(1), skidpad_time(1), endur_time(1) * 0.8/22, endur_time(1));
end
...
function [score] = lap2score(accel_time, skid_time, autox_time, endur_time)
